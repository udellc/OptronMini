...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 382.670898, 371.425537, 446.0, 20.0 ],
					"text" : "route tonic scale_basis chord_root chord_struct scale_struct bpm harm 4bar_sync"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 247.0, 406.898621, 35.0, 20.0 ],
					"text" : "== 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 247.0, 432.44931, 54.0, 20.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 190.492081, 134.178009, 59.507919, 19.0 ],
					"text" : "update list"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 171.492081, 134.178009, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 189.492081, 108.0, 60.507919, 18.0 ],
					"text" : "Steal Mode"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 169.5746, 108.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 98.0, 352.0, 67.0, 20.0 ],
					"text" : "update me"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 77.0, 351.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 386.0, 46.0, 20.0 ],
					"triscale" : 0.9,
					"varname" : "flonum"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 29.0, 386.0, 37.0, 20.0 ],
					"text" : "bpm:"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 120.0, 435.0, 39.0, 20.0 ],
					"text" : "sync:"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 155.0, 435.0, 19.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 189.0, 435.0, 37.0, 20.0 ],
					"text" : "start:"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 222.0, 435.0, 19.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 113.0, 377.0, 133.0, 50.0 ],
					"range" : [ 0.0, 1.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 408.0, 46.0, 20.0 ],
					"triangle" : 0,
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.588, 408.0, 65.0, 20.0 ],
					"text" : "4bar_freq:"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 374.0, 250.0, 90.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 167.0, 250.0, 207.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 222.5, 330.852875, 103.0, 20.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 186.492081, 76.425537, 51.0, 34.0 ],
					"text" : "slave\nmaster"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 171.5746, 77.411438, 18.0, 30.0 ],
					"size" : 2,
					"value" : 0,
					"varname" : "radiogroup"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 204.5, 431.0, 200.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 78.0, 307.477997, 54.0, 20.0 ],
									"text" : "route int"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 78.0, 339.495728, 50.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 78.0, 370.495789, 101.0, 18.0 ],
									"text" : "makeNetsend $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 78.0, 401.495789, 19.0, 20.0 ],
									"saved_object_attributes" : 									{
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 189.283035, 357.495728, 32.5, 20.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 189.283035, 301.495728, 33.0, 20.0 ],
									"text" : "t b s"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"patching_rect" : [ 189.283035, 331.495728, 81.0, 20.0 ],
									"text" : "counter 0 0 9"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 189.283035, 389.495789, 121.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 475.196808, 417.5, 25.0, 25.0 ],
									"varname" : "inlet2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 412.696808, 523.0, 150.0, 64.0 ],
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 212.783035, 323.0, 416.78302, 323.0 ],
									"source" : [ "obj-32", 1 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.0, 364.425537, 99.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 256.5, 455.0, 563.5, 455.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "genNetsend.js",
				"bootpath" : "/Users/cudell/Dropbox/CoursePlans/NetworkMusic/mpg_cp20091111/add to Cycling74 folder",
				"patcherrelativepath" : "",
				"type" : "TEXT",
				"implicit" : 1
			}
